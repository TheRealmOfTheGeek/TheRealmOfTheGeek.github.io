...
<div class="roow" id="donate">
	<div class="container text-left">
		<h1>Support me</h1>
		<p>First off, I almost never ask for donations, but, my current PC is not currently working (near dead). Because of this, I am having major issues recording high quality videos, so I am looking toward the community to possibly help me raise the little bit of cash more that I need. In return, I will upload as much as possible during this summer. Thank you, and DO NOT feel obligated to donate, only do so if you can afford it. After I recieve the payment, I will be getting in touch to you through the PayPal email address you used to get your Discord username, as well as 1 social media account to link in *all* of my videos that come out during the summer time to show my appreciation to you.<br>Another way of helping me out is to purchase a website, so you get something in return (that isn't a shoutout or Discord role).<br>Or lastly, you could enable my affiliate link for amazon (which doesn't add any cost to your products) by clicking </p> <a target="_blank" href="https://www.amazon.com/b?_encoding=UTF8&tag=kvizdos-20&linkCode=ur2&linkId=0c89bd34c12e7320785bc39bc7187ac5&camp=1789&creative=9325&node=172282">here</a><img src="//ir-na.amazon-adsystem.com/e/ir?t=kvizdos-20&l=ur2&o=1" width="1" height="1" border="0" alt="" style="border:none !important; margin:0px !important;" />

		<h1><a href="https://www.paypal.me/kentonv">Donate Using PayPal.me! (Click this message)</a></h1>
</div>
</div>
